...
export default function ContrastCheck(props) {
    ...
    return (
        <div className="contrast-checker modal" role="dialog" aria-label="Contrast Checker" aria-modal="true">
            <button className="modal-exit" aria-label="Exit Contrast Checker" onClick={props.onModalClose}>
